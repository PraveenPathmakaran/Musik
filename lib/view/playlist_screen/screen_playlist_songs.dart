                        ...
                        child: ListTile(
                          onTap: () async {
                            await createAudiosFileList(
                                playlistController.playlistSongsFromDB);
                          ...
                          title: Text(
                            playlistController.playlistSongsFromDB[index].title
                                .toString(),
                            maxLines: 1,
                          ...
                          subtitle: Text(
                            playlistController.playlistSongsFromDB[index].artist
                                .toString(),
                            maxLines: 1,
                            style: const TextStyle(
                          ...
                          trailing: IconButton(
                            icon:
                                functionIcon(Icons.more_vert, 25, Colors.white),
                            onPressed: () {
                              showModalBottomSheet(
                                backgroundColor: kAppbarColor,
                                shape: const RoundedRectangleBorder(
